...
liveDemo: https://mailroom.sampacker.com
pinned: true
pubDate: "December 20, 2024"
image: "../../assets/projects/mailroom_photo.webp"
badge: "Demo"
...
<LoginDemoBox username="admin@mailroom.com" password="admindemo"/>
...
#### User Management
A robust user management page allows property managers to create, update, and manage resident information.
...
I implemented cookie based authentication with .NET to ensure secure access to the system. Sensitive data and user information is safeguarded and passwords are hashed.
...
#### Responsive UI
I replaced the default UI framework used in .NET (Bootstrap) with TailwindCSS and daisyUI. This allowed for a responsive UI that works well on desktop and mobile devices.
